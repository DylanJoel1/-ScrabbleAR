        ...
        if dificultad == "-facil-":
            for p in POS_ESPECIALES["facil"]["x2letra"]:
                if p == (pos[0],pos[1]):
                    ...
                    window["-out-"].print("Multiplicador de letra x2", text_color='black')
            for p in POS_ESPECIALES["facil"]["x3letra"]:
                if p == (pos[0],pos[1]):
                    agregado = agregado + (fichas_punt[key]*2)
                    window["-out-"].print("Multiplicador de letra x3", text_color='black')
    ...
    try:
        if dificultad == "-facil-":
            for p in POS_ESPECIALES["facil"]["x2"]:
                if p == (pos1,pos2):
                    punt = punt*2
                    window["-out-"].print("Multiplicador de palabra x2", text_color='black')
            for p in POS_ESPECIALES["facil"]["x3"]:
                if p == (pos1,pos2):
                    punt = punt*3
                    window["-out-"].print("Multiplicador de palabra x3", text_color='black')
